        ...
        <div class="col-12 my-2">
            <div class="card rounded shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.episode.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="air_time" class="form-control @error('air_time') is-invalid @enderror" value="{{ old('air_time') }}">
                            @error('air_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
